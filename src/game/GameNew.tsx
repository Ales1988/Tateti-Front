...
export default function NewGame() {
  ...
  let player = useSessionUser()!;  //El !; sirve para decire a typescript que player1 no va a ser undefined
  let player1_id = player.id
  ...
  const registerClick = async () => {
    ...
    try {
     let game = await newGame({ //En game voy a tener el game que POST con newGame en el back
        player1_id,
        gameName
      })
